 ...
 *
 * This template can be overridden by copying it to yourtheme/woocommerce/emails/plain/customer-paymentonsite.php.
 *
...
echo sprintf( esc_html__( 'Hi %s,', 'tmsm-woocommerce-paymentonsite-status' ), esc_html( $order->get_billing_first_name() ) ) . "\n\n";
